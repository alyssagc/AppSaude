...
#Funcionários/1
Funcionario.create!(name: 'Pedro', cpf: 1234567898, email: 'teste1@teste.com', user: acme, data_admissao: DateTime.strptime('09/01/2020','%d/%m/%Y') , peso:65, altura:175)
Funcionario.create!(name: 'José', cpf: 7863728394, email: 'teste2@teste.com', user: acme, data_admissao: DateTime.strptime('19/03/2019','%d/%m/%Y'), peso:80, altura:150)
Funcionario.create!(name: 'André', cpf: 6738374652, email: 'teste3@teste.com', user: acme, data_admissao: DateTime.strptime('29/10/2010','%d/%m/%Y'), peso:70, altura:190)
Funcionario.create!(name: 'Julia', cpf: 8765467389, email: 'teste4@teste.com', user: acme, data_admissao: DateTime.strptime('09/01/2020','%d/%m/%Y') , peso:65, altura:175)
Funcionario.create!(name: 'Maria', cpf: 9825364758, email: 'teste5@teste.com', user: acme, data_admissao: DateTime.strptime('19/03/2019','%d/%m/%Y'), peso:50, altura:150)
Funcionario.create!(name: 'Joana', cpf: 1793457276, email: 'teste6@teste.com', user: acme, data_admissao: DateTime.strptime('29/10/2010','%d/%m/%Y'), peso:90, altura:160)
